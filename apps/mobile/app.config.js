module.exports = ({ config }) => {
  ...
  const authIssuer = process.env.AUTH_ISSUER || "http://localhost:8081/realms/mcd3";
...
`);
  ...
  return {
    ...
    extra: {
      ...
      // 開発環境でもWorker同期テストのため一時的にfalseに設定
      useMockAuth: false,  // appEnv === "production" ? false : true,
      appEnv,  // アプリ内で環境判定に使用
